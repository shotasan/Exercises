$(document).ready(function(){
  ...
  function get_achievement(){
    ...
    $(".container").find("#btn-evaluation").click(function(){
        let avarage = Number($("#avarage_indicate").text()); //平均点で表示された数字を変数avarageに代入
  ...
  function get_pass_or_failure(){
    ...
    $(".container").find("#btn-judge").click(function(){
